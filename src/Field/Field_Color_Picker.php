...
use CustomizerFramework\Field\Setting\Color_Picker_Setting;
 ...
 * @version 1.0.0
 */
final class Field_Color_Picker extends Color_Picker_Setting
{
	/**
	...
	public function render(WP_Customize_Manager $wp_customize, array $args)
    {
        ...
        $wp_customize->add_control(new Color_Picker_Control($wp_customize, $id . '_field', $this->args));
	}
}
