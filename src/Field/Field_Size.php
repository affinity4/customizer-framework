...
use CustomizerFramework\Field\Setting\Size_Setting;
use WP_Customize_Manager;

final class Field_Size extends Size_Setting
{
    /**
	 * Render field
	 *
	...
	public function render(WP_Customize_Manager $wp_customize, array $args)
    {
        ...
        $wp_customize->add_control(new Size_Control( $wp_customize, $id . '_field', $this->args));
	}
}
